...
function main() {
  ...
  packageJson.contributes.configuration.properties = {
    "clang-format.executable": packageJson.contributes.configuration.properties["clang-format.executable"],
    "clang-format.executable.windows": packageJson.contributes.configuration.properties["clang-format.executable.windows"],
    "clang-format.executable.linux": packageJson.contributes.configuration.properties["clang-format.executable.linux"],
    "clang-format.executable.osx": packageJson.contributes.configuration.properties["clang-format.executable.osx"],
    "clang-format.style": packageJson.contributes.configuration.properties["clang-format.style"],
    "clang-format.fallbackStyle": packageJson.contributes.configuration.properties["clang-format.fallbackStyle"],
    ...languageConfigs,
    "clang-format.assumeFilename": packageJson.contributes.configuration.properties["clang-format.assumeFilename"]
  };
